...
assign sub_parallel_block[0] = 1'b0 | ((idx3_block & (axis_block_sigs[4] | axis_block_sigs[5])) & ((idx2_block | inst_idle_sigs[2]) & (idx1_block | inst_idle_sigs[1]))) | ((idx2_block & (axis_block_sigs[2] | axis_block_sigs[3])) & ((idx3_block | inst_idle_sigs[3]) & (idx1_block | inst_idle_sigs[1]))) | ((idx1_block & (axis_block_sigs[0] | axis_block_sigs[1])) & ((idx3_block | inst_idle_sigs[3]) & (idx2_block | inst_idle_sigs[2])));
