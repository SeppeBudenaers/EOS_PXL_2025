...
HD_PWD='C:/PXL/EOS_PXL_2025/Pynq-Z2-Video/hw_proj.runs/video_out_pynq_z2_v_tc_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_out_pynq_z2_v_tc_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_out_pynq_z2_v_tc_0_1.tcl
