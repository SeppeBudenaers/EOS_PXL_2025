...
video_out_pynq_z2_v_tpg_0_0_reg_int_s grp_reg_int_s_fu_2088(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
video_out_pynq_z2_v_tpg_0_0_urem_11ns_3ns_2_15_1 #(
    .ID( 1 ),
    .NUM_STAGE( 15 ),
    .din0_WIDTH( 11 ),
    .din1_WIDTH( 3 ),
...
(* dissolve_hierarchy = "yes" *) video_out_pynq_z2_v_tpg_0_0_sparsemux_7_2_9_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 2'h0 ),
    .din0_WIDTH( 9 ),
...
(* dissolve_hierarchy = "yes" *) video_out_pynq_z2_v_tpg_0_0_sparsemux_7_16_8_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 16'h0 ),
    .din0_WIDTH( 8 ),
...
(* dissolve_hierarchy = "yes" *) video_out_pynq_z2_v_tpg_0_0_sparsemux_7_2_8_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 2'h2 ),
    .din0_WIDTH( 8 ),
