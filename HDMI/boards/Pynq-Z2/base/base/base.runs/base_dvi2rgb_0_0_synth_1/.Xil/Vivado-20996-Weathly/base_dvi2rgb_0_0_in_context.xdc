create_clock -period 6.060 [get_ports -no_traverse {PixelClk}]
...
set_property -quiet CLOCK_PERIOD_OOC_TARGET 5.000 [get_ports -no_traverse -quiet RefClk]
set_property -quiet CLOCK_PERIOD_OOC_TARGET 6.060 [get_ports -no_traverse -quiet TMDS_Clk_p]
set_property -quiet IS_IP_OOC_CELL TRUE [get_cells -of [get_ports -no_traverse -quiet DDC_SCL_I]]
