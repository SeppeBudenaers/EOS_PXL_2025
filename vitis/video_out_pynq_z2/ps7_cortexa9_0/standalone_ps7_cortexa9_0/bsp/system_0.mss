...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = iop_arduino_mb_bram_ctrl
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.10
 PARAMETER HW_INSTANCE = iop_pmoda_mb_bram_ctrl
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.10
 PARAMETER HW_INSTANCE = iop_pmodb_mb_bram_ctrl
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.10
 PARAMETER HW_INSTANCE = iop_rpi_mb_bram_ctrl
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = trace_analyzer_pi_axi_dma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = trace_cntrl_64
 PARAMETER DRIVER_VER = 1.4
 PARAMETER HW_INSTANCE = trace_analyzer_pi_trace_cntrl_64_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.18
 PARAMETER HW_INSTANCE = trace_analyzer_pmodb_axi_dma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = trace_cntrl_32
 PARAMETER DRIVER_VER = 1.4
 PARAMETER HW_INSTANCE = trace_analyzer_pmodb_trace_cntrl_32_0
END
